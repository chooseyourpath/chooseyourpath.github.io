...
(function () {
    ...
    DedalusWeb.prototype.executePrintingOriginal = function (content, turnPage) {
        var isTurn          = turnPage || false,
    ...
    DedalusWeb.prototype.executePrinting1 = function (content, turnPage) {
        var isTurn          = turnPage || false;
        var tempContent = content();
        console.log("DedalusWeb.executePrinting:tempContent=" + tempContent);
