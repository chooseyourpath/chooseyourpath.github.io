...
(function () {
     ...
     */
    Dedalus.prototype.showParagraph1 = function (target) {
    ...
    Dedalus.prototype.showParagraph = function (target) {
        console.log("showParagraph:target=" + target);
        
        var paragraphToPrint = this.getParagraph(target);
        console.log("showParagraph:paragraphToPrint=",paragraphToPrint);

        var content          = paragraphToPrint.content;
        var modifiedContent = '<p id="' + target + '">' + content() + '<\p>';


        this.executeBeforeEveryParagraphShown();
        
        this.print(modifiedContent);
    ...
    Dedalus.prototype.getParagraph = function (id) {
        ...
        console.log("maybeParagraph=", maybeParagraph);
